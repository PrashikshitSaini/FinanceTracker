        ...
        <Card className="border border-border/50 shadow-2xl bg-card/95 backdrop-blur-sm">
          <CardHeader className="text-center space-y-6 pb-6">
            ...
            <div className="flex flex-col items-center gap-4">
              <div className="w-20 h-20 rounded-full border-2 border-foreground/20 shadow-lg overflow-hidden bg-white/5 backdrop-blur-sm flex items-center justify-center">
